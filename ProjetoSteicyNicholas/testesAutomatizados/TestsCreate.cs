...
//             testPurchase.setDate_purchase(date);
//             testPurchase.setNumber_confirmation("0123456");
//             testPurchase.setNumber_nf("987654321");
//             testPurchase.setPayment_type(Enums.PaymentEnum.initial);
//             testPurchase.setPurchase_status(Enums.PurchaseStatusEnum.awaitingPayment);
